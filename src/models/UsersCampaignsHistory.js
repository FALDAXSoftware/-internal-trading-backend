/**
 * Users Campaign Model to work with Objection
 *
 */
...
// Users Campaign Model.
class UsersCampaignsHistory extends AppModel {
	...
	*/
	...
	static async create( data ){
		var add_data = await UsersCampaignsHistory
			.query()
			.insertAndFetch( data );
		if( add_data ){
			return 1;
	...
	static async update(filter, updateData) {
		var getData = await UsersCampaignsHistory
			.query()
			.where(filter)
			.first();
...
module.exports = UsersCampaignsHistory;