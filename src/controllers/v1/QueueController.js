...
amqp.connect(CONN_URL, opt, (err, conn) => {
    ...
    conn.createChannel(function (err, channel) {
        ...
        ch.consume(process.env.QUEUE_NAME + '-LTC-BTC', (msg, err) => {
            // console.log("mesages");
            console.log(err)
            console.log("Message", msg.content.toString())
            var tradeData = require("./TradeController");
        ...
        ch.consume(process.env.QUEUE_NAME + '-BCH-BTC', (msg, err) => {
            // console.log("mesages");
            console.log(err)
            console.log("Message", msg.content.toString())
            var tradeData = require("./TradeController");
        ...
        ch.consume(process.env.QUEUE_NAME + '-ETH-BTC', (msg, err) => {
            // console.log("mesages");
            console.log(err)
            console.log("Message", msg.content.toString())
            var tradeData = require("./TradeController");
        ...
        ch.consume(process.env.QUEUE_NAME + '-SUSU-BTC', (msg, err) => {
            // console.log("mesages");
            console.log(err)
            console.log("Message", msg.content.toString())
            var tradeData = require("./TradeController");
        ...
        ch.consume(process.env.QUEUE_NAME + '-XRP-ETH', (msg, err) => {
            // console.log("mesages");
            console.log(err)
            console.log("Message", msg.content.toString())
            var tradeData = require("./TradeController");
        ...
        ch.consume(process.env.QUEUE_NAME + '-BCH-ETH', (msg, err) => {
            // console.log("mesages");
            console.log(err)
            console.log("Message", msg.content.toString())
            var tradeData = require("./TradeController");
        ...
        ch.consume(process.env.QUEUE_NAME + '-LTC-ETH', (msg, err) => {
            // console.log("mesages");
            console.log(err)
            console.log("Message", msg.content.toString())
            var tradeData = require("./TradeController");
